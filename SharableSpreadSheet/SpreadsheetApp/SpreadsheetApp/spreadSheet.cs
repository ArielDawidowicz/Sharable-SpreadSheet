...
namespace SpreadsheetApp
{
    internal class SharableSpreadSheet
    {
        ...
        public void load(String fileName)
        {
            ...
            rows_mutex = s0.rows_mutex;
            cols_mutex = s0.cols_mutex;
            searchers_counter = s0.searchers_counter;
            non_writers_counter = s0.non_writers_counter;
            concurrentSearchLimit = s0.concurrentSearchLimit;
            writerRelease();
            }
